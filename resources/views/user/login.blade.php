      ...
      <div class="col-md-6 mx-auto col-sm-7 p-4 bg-white rounded op-8 border border-theme-vii border-width-3">
        ...
        <form class="mt-3 clearfix" action="{{ route('login.user') }}" method="post">
            ...
            <p class="clearfix text-uppercase mt-2">
                <a href="{{ route('ResetPassword.view') }}" class="text-right"><small id="forgotpassword" class="form-text text-dark text-capitalize">"j'ai predu mon mot de passe"</small></a>
                <a href="{{ route('register.view') }}" class="text-right"><small class="form-text text-dark">Register</small></a>
            </p>
          {{--<div class="form-group">--}}
        ...
        <p class="mt-4 clearfix text-uppercase">
          <a href="#" class="text-center"><small id="forgotpassword" class="form-text text-dark">Vous n'avez pas de compte ? Contactez votre administrateur</small></a>
        </p>
      </div>
    </div>
  </div>
