...
<!-- custom -->
<script src="{{ asset('js/super_admin/custom.js') }}"></script>
...
@if(Route::current()->getName() == 'super_admin.dashboard')
    ...
    gapi.analytics.ready(function() {
       ...
       */
            gapi.analytics.auth.authorize({
                ...
                clientid: '337873241921-9torboh82cjo4loc346930emj7reibk5.apps.googleusercontent.com'
            });
      ...
      function renderWeekOverWeekChart(ids) {
        ...
        Promise.all([lastWeek,thisWeek]).then(function(results) {
            ...
            datasets : [
              {
                ...
                pointColor : 'rgba(255, 193, 7,0.5)',
                pointStrokeColor : '#fff',
                data : data1
              },
              {
                label: 'This Weeks',
                fillColor : 'rgba(32, 168, 216,0.5)',
                strokeColor : 'rgba(32, 168, 216,0.5)',
                pointColor : 'rgba(32, 168, 216,0.5)',
                pointStrokeColor : '#fff',
                data : data2
              }
            ]
